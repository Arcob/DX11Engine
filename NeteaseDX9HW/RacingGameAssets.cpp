...
bool RacingGameAssets::Load() {
	...
	std::shared_ptr<DX11Engine::ArcMesh> pSkyboxMesh = DX11Engine::ArcAssetLoader::LoadMesh("Sphere Mesh", sphereMeshData->vertices.data(), (unsigned int)sizeof(DX11Engine::VertexNormalTangentTex), (unsigned int)sphereMeshData->vertices.size(), sphereMeshData->indices.data(), (unsigned int)sphereMeshData->indices.size(), nullptr);
	...
	std::shared_ptr<DX11Engine::ArcMesh> pCylinderMesh = DX11Engine::ArcAssetLoader::LoadMesh("Cylinder Mesh", cylinderMeshData->vertices.data(), (unsigned int)sizeof(DX11Engine::VertexNormalTangentTex), (unsigned int)cylinderMeshData->vertices.size(), cylinderMeshData->indices.data(), (unsigned int)cylinderMeshData->indices.size(), nullptr);
	...
	std::shared_ptr<DX11Engine::ArcMesh> pGeneratedBoxMesh = DX11Engine::ArcAssetLoader::LoadMesh("Generated Box Mesh", generatedCubeMeshData->vertices.data(), (unsigned int)sizeof(DX11Engine::VertexNormalTangentTex), (unsigned int)generatedCubeMeshData->vertices.size(), generatedCubeMeshData->indices.data(), (unsigned int)generatedCubeMeshData->indices.size(), nullptr);
