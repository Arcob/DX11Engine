...
void ShadowCameraController::SetCurLightInfo() {
	...
	//for (int i = 0; i < 4; i++)
	//{
	//	lightCorner.nearCorners[i] = TransformCoord(corner->nearCorners[i], cachedDirectionalLight->GetLightCamera(0)->View());
	//	lightCorner.farCorners[i] = TransformCoord(corner->farCorners[i], cachedDirectionalLight->GetLightCamera(0)->View());
	//}
